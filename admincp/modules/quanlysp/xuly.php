...
include('../../config/config.php');
   ...
   header('location:../../index.php?action=quanlysp&query=them');
      ...
      if($hinhanh !=''){
         ...
         ". $giasp."', soluong='". $soluong."', hinhanh='". $hinhanh_time."', tomtat='". $tomtat."', noidung='". $noidung."', tinhtrang='". $tinhtrang
         ...
         $sql_update = "UPDATE tbl_sanpham SET tensanpham='". $tensanpham."',masp='".$masp."', giasp='
         ". $giasp."', soluong='". $soluong."', tomtat='". $tomtat."', noidung='". $noidung."', tinhtrang='". $tinhtrang
         ."',id_danhmuc='". $danhmuc."' WHERE id_sanpham='$_GET[idsanpham]'";
      }
